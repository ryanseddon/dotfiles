...
hs.hotkey.bind(spectaclehyper, "down", function ()
  pressed.down = true
  if pressed.up then
    fullDimension('h')
  else
...
hs.hotkey.bind(spectaclehyper, "right", function ()
  pressed.right = true
...
hs.hotkey.bind(spectaclehyper, "left", function ()
  pressed.left = true
...
hs.hotkey.bind(spectaclehyper, "up", function ()
  pressed.up = true
...
hs.hotkey.bind(spectaclehyper, "f", function ()
  nextFullScreenStep()
end)

hs.hotkey.bind(spectaclehyper, "i", function ()
  local win = hs.window.frontmostWindow()
  local id = win:id()
  local screen = win:screen()
  cell = hs.grid.get(win, screen)
